...
\raggedright \textbf{Caluclating Other Coordinate: } \\
 ...
 \end{pmatrix}$% 
   Using the Cosine formula in  $\Delta$ABC, \\
    ${b}^2$ = ${a}^2$ + ${c}^2$ - 2accosB.\\
  \centering $\implies$ (b+c)(b-c)+${7}^2$ - 2 $\times$ 7 $\times$ 0.25c \\
  \centering $\implies$ b-1.26c=3.76 ....1\\
...
The below python code realizes the above construction:	
 ...
 https://github.com/manasareddy442002/fwc-moudle1/blob/5766de94c6f0b420a0ac6c40ab49c4418fa4df35/matrix-lines/matrix.py
