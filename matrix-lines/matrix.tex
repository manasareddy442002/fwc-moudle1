...
\raggedright Let the coordinates of A are X2,Y2 respectively. \\
...
${b}^2$\hspace{1.5cm}= ${a}^2$ + ${c}^2$ - 2accosB. \vspace{2mm}\\
(b+c) (b-c) = ${a}^2$ - 2 $\times$ a $\times$ 0.25c \vspace{2mm}\\
 b-1.26c\hspace{0.7cm}  = 3.76....1 \vspace{2mm}\\
   Upon Simplifaction we get:- \\
       b+c\hspace{1.3cm}=$13$ ....2  \\
   ...
   \\  Thus,the vertices of $\Delta$ ABC are \\
     \raggedright Let \textbf{A} = 7.66 $\begin{pmatrix}
                 cos 75 \\
                 sin 75 \\
              \end{pmatrix}$% 
              \\ \raggedright Let \textbf{B} = $\begin{pmatrix}
                 0\\
                 0\\
              \end{pmatrix}$% 
             \\ \raggedright Let \textbf{C} = $\begin{pmatrix}
                  7\\
                  0\\
              \end{pmatrix}$% 
